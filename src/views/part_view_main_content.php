...
<main id="content">
    <section id="home">
        ...
        <div id="cta">
            ...
            <div id="cta_buttons">
                <a href="./../../src/Controller/AppController.php?rota=UserCrudController.php&action=cardapio" class="btn-default">Ver cardápio</a>
        ...
        <div id="banner">
            <img src="./src/views/Assets/Imagens/hero.png" alt="">
        </div>
    </section>
    <section id="menu">
        ...
        <div id="pratos">
            <div class="prato">
                <div class="prato-inner">
                    <div class="prato-front">
                        ...
                        <img src="./src/views/Assets/Imagens/dish.png" class="prato-image" alt="">
            ...
            <div class="prato">
                <div class="prato-inner">
                    <div class="prato-front">
                        <div class="prato-heart"><i class="fa-solid fa-heart"></i></div>
                        <img src="./src/views/Assets/Imagens/cremedepepino.png" class="prato-image" alt="">
            ...
            <div class="prato">
                <div class="prato-inner">
                    <div class="prato-front">
                        <div class="prato-heart"><i class="fa-solid fa-heart"></i></div>
                        <img src="./src/views/Assets/Imagens/dish3.png" class="prato-image" alt="">
            ...
            <div class="prato">
                <div class="prato-inner">
                    <div class="prato-front">
                        <div class="prato-heart"><i class="fa-solid fa-heart"></i></div>
                        <img src="./src/views/Assets/Imagens/dish4.png" class="prato-image" alt="">
    ...
    <section id="testimonials">
        <img src="./src/views/Assets/Imagens/chef.png" id="testimonial_chef" alt="">
        <div id="testimonials_content">
            <h2 class="section-title">Depoimentos</h2>
            <h3 class="section-subtitle">O que os clientes falam sobre nós</h3>
            <div id="feedbacks">
                <div class="feedback">
                    <img src="./src/views/Assets/Imagens/avatar2.jfif" class="feedback-avatar" alt="">
                ...
                <div class="feedback">
                    <img src="./src/views/Assets/Imagens/avatar3.jfif" class="feedback-avatar" alt="">
                    <div class="feedback-content">
